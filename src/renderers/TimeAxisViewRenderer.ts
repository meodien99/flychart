...
const optimizationReplacementRegex = /[1-9]/g;
...
export class TimeAxisViewRenderer implements ITimeAxisViewRenderer {
    ...
    public draw(ctx: CanvasRenderingContext2D, rendererOptions: TimeAxisViewRendererOptions): void {
        ...
        const y1 = -0.5;
        const y2 = y1 + rendererOptions.borderSize + rendererOptions.paddingTop + rendererOptions.paddingBottom + rendererOptions.fontSize;
