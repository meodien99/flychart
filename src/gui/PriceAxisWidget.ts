...
import { clearRect, resizeCanvas, Size, addCanvasTo } from "./canvas-utils";
import { TouchMouseEvent, MouseEventHandler, MouseEventHandlers } from "./MouseEventHandler";
...
import { PriceScalePosition } from "../models/Pane";
...
export class PriceAxisWidget implements IDestroyable {
	...
	public destroy(): void {
		...
		if (this._updateTimeout !== null) {
			clearTimeout(this._updateTimeout as number);
	...
	public getWidth(): number {
		return ensureNotNull<Size>(this._size).w;
	}
	...
	public paint(type: InvalidateLevel): void {
		...
		if (type === InvalidateLevel.Cursor) {
