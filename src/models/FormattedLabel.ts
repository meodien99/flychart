...
export type TransducerFunc = (value: Date) => string;

export class LabelCache {
    private readonly _format: TransducerFunc;
    ...
    public constructor(format: TransducerFunc, size: number = 50) {
        this._format = format;
        this._maxSize = size;
    }
